Для организации работы сайта, была взята структура новостного блога, для формирования постов об известных людях,
...
Убедились, что файл gunicorn.sock присутствует в папке /run:
